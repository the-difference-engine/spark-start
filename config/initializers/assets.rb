...
Rails.application.config.assets.precompile += ['bootstrap.css', 'font-awesome.css', 'et-line.css', 'hover-min.css', 'animate.css', 'owl.carousel.css', 'owl.theme.css', 'owl.transitions.css', 'lightbox.css', 'flexslider.css', 'masterslider.css', 'style.css', 'cubeportfolio.css', 'cs.style.css', 'custom_style.css']